...
const AllTask = () => {
 ...
 const [userData,setUserData] = useContext(AuthContext);
  ...
  return (
    ...
    <div id="AllTask" className='bg-[#1c1c1c] p-5  rounded mt-5 h-60  '>
      ...
      {userData.map(function(elem,idx){
         return  <div key={idx} className=' mb-2 py-2 px-4 flex justify-between border-2 border-emerald-600'  >
        ...
        <h5 className='text-lg font-medium w-1/5 text-white-400'>{elem.taskCount.completed}</h5>
